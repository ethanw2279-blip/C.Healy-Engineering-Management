...
export const seed: State = {
  employees: [
    { id: 'e1', name: 'Ethan Whitney', role: 'Owner', email: 'ethan@ewdetailing.ie', phone: '087 123 4567', hourlyRate: 0, color: '#1F8A4C', active: true },
    { id: 'e2', name: 'Marcus Reilly', role: 'Field crew', email: 'marcus@ewdetailing.ie', phone: '086 234 5678', hourlyRate: 22, color: '#2F86EB', active: true },
    { id: 'e3', name: 'Sofia Nolan', role: 'Field crew', email: 'sofia@ewdetailing.ie', phone: '085 345 6789', hourlyRate: 22, color: '#C7791C', active: true },
    { id: 'e4', name: 'Liam Byrne', role: 'Field crew', email: 'liam@ewdetailing.ie', phone: '083 456 7890', hourlyRate: 20, color: '#7A2B3A', active: true },
    { id: 'e5', name: 'Aoife Kelly', role: 'Dispatcher', email: 'aoife@ewdetailing.ie', phone: '089 567 8901', hourlyRate: 24, color: '#5B4FB5', active: true },
  ],
  clients: [
